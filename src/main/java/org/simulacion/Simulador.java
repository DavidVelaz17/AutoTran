...
public class Simulador {
    ...
    public static void main(String[] args) {
        ...
        Auto auto1 = new Auto("AUTO-001", 500, "Base Central");
        Dron dron1 = new Dron("DRON-001", 10, "Hangar Norte");
        Submarino submarino1 = new Submarino("SUB-001", 2000, "Puerto Este");
        Anfibio anfibio1 = new Anfibio("ANF-001", 800, "Base Mixta");
